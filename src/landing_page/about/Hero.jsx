function Hero() {
  return (
    <div className="container mt-5 py-5">
      <div className="row">
        <h4 className="text-center my-5 py-5 border-bottom mx-auto w-75">
          We pioneered the discount broking model in India.
          <br /> Now, we are breaking ground with our technology.
        </h4>
      </div>
      <div className="row px-5 fs-6 leading-loose w-75 mx-auto">
        ...
        <div className="col-6 my-2">
          ...
          <p>
            ...
            is
            <a href="#"> saying about us </a> or learn more about our business
